$("#example").czmChatSupport({
  ...
  button: {
    ...
    notificationNumber:
      "4" /* Custom text or false. To remove, (notificationNumber:false) */,
    speechBubble:
      "Ada yang perlu torang bantu?" /* To remove, (speechBubble:false) */,
  ...
  popup: {
    ...
    header: {
      ...
      description:
        "Klik salah satu Team SaCode di bawah ini" /* To remove, (description:false) */,
    },
    ...
    persons: [
      ...
      {
        avatar: {
          src: '<img src="assets/img/whatsapp-avatars/lidia-orain.png" alt="Lidia Orain">' /* Image, Icon or SVG */,
          backgroundColor: "#10c379" /* Html color code */,
          onlineCircle: true /* Avatar online circle. To remove, (onlineCircle:false) */,
        },
        text: {
          title: "Lidia Orain" /* Writing is required */,
          description: "Team SaCode" /* To remove, (description:false) */,
          online: "Sa Online" /* To remove, (online:false) */,
          offline: "Sedang Offline" /* To remove, (offline:false) */,
        },
        link: {
          desktop:
            "https://web.whatsapp.com/send?phone=+6281247832877&text=Hi, Lidia!" /* Writing is required */,
          mobile:
            "https://wa.me/+6281247832877/?text=Hello, Lidia!" /* If it is hidden desktop link will be valid. To remove, (mobile:false) */,
        },
        onlineDay: {
      ...
      /* Copy for more representatives [::Start Copy::] */
      {
        ...
        link: {
          desktop:
            "https://web.whatsapp.com/send?phone=+6281224452338&text=Hi, Stenly!" /* Writing is required */,
          mobile:
            "https://wa.me/+6281224452338/?text=Hello, Stenly!" /* If it is hidden desktop link will be valid. To remove, (mobile:false) */,
        },
        onlineDay: {
          /* Change the day you are offline like this. (sunday:false) */
          sunday: "09:00-20:59",
      ...
      /* Copy for more representatives [::Start Copy::] */
      {
        ...
        text: {
          ...
          description:
            "Team SaCode" /* Custom text or false. To remove, (description:false) */,
          online:
            "Sa Online" /* Custom text or false. To remove, (online:false) */,
          offline:
            "Sedang Offline" /* Custom text or false. To remove, (offline:false) */,
        },
        link: {
          desktop:
            "https://web.whatsapp.com/send?phone=+6282198159714&text=Hi, Samuel!" /* Writing is required */,
          mobile:
            "https://wa.me/+6285243688850/?text=Hello, Septemina!" /* If it is hidden desktop link will be valid. To remove, (mobile:false) */,
        },
        onlineDay: {
          /* Change the day you are offline like this. (sunday:false) */
          sunday: "09:00-20:59",
      ...
      /* Copy for more representatives [::Start Copy::] */
      {
        ...
        link: {
          desktop:
            "https://web.whatsapp.com/send?phone=+6282198159714&text=Hi, Samuel!" /* Writing is required */,
          mobile:
            "https://wa.me/+6282198159714/?text=Hello, Samuel!" /* If it is hidden desktop link will be valid. To remove, (mobile:false) */,
        },
        onlineDay: {
          /* Change the day you are offline like this. (sunday:false) */
          sunday: "09:00-20:59",
